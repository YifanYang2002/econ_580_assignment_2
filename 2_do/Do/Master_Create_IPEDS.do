...
*/
cd "/Users/handsomedoge/Desktop/Replication/580-selected/"
use directorymaster1_2017.dta
...
merge 1:1 unitid year using institutionmaster1_2017.dta
drop if _merge!=3
drop _merge
...
sort unitid year
merge 1:1 unitid year using revenuesmaster1_2017.dta
drop if _merge==2
drop _merge
...
sort unitid year
merge 1:1 unitid year using facultymaster1_2017.dta
drop if _merge==2
drop _merge
sort unitid year
merge 1:1 unitid year using tuitionmaster1_2017.dta
drop if _merge==2
drop _merge
