...
label define label_xoutlaym 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xoutlaym 51 "Outlier value derived from imported data", add 
label define label_xoutlaym 52 "Value not derived - parent/child differs across components", add 
label define label_xoutlaym 53 "Value not derived - data not usable", add 
...
label define label_xavesalm 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xavesalm 51 "Outlier value derived from imported data", add 
label define label_xavesalm 52 "Value not derived - parent/child differs across components", add 
label define label_xavesalm 53 "Value not derived - data not usable", add 
...
label define label_xoutlayw 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xoutlayw 51 "Outlier value derived from imported data", add 
label define label_xoutlayw 52 "Value not derived - parent/child differs across components", add 
label define label_xoutlayw 53 "Value not derived - data not usable", add 
...
label define label_xavesalw 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xavesalw 51 "Outlier value derived from imported data", add 
label define label_xavesalw 52 "Value not derived - parent/child differs across components", add 
label define label_xavesalw 53 "Value not derived - data not usable", add 
...
label define label_xoutlayt 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xoutlayt 51 "Outlier value derived from imported data", add 
label define label_xoutlayt 52 "Value not derived - parent/child differs across components", add 
label define label_xoutlayt 53 "Value not derived - data not usable", add 
...
label define label_xavesalt 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xavesalt 51 "Outlier value derived from imported data", add 
label define label_xavesalt 52 "Value not derived - parent/child differs across components", add 
label define label_xavesalt 53 "Value not derived - data not usable", add 
